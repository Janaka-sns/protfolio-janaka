  ...
  const workExperience = [
    {
      ...
      period: "2021 - Present",
      responsibilities: [
        "Led development of enterprise payment solutions using Java and Spring Boot",
        "Architected and implemented microservices architecture for scalable applications",
    ...
    },
    {
      ...
      period: "2020 - 2021",
      responsibilities: [
        "Developed full-stack web applications using Java, Angular, and modern frameworks",
        "Implemented business automation systems improving operational efficiency",
          ...
          <div className="space-y-6">
            <div className="card-elevated p-8">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  With over 4 years of hands-on experience in software engineering, I specialize in 
                  building robust, scalable applications using Java technologies and modern front-end 
                ...
                {workExperience.map((job, index) => (
                  <div key={index} className="relative">
                    {index !== workExperience.length - 1 && (
                      <div className="absolute left-0 top-8 w-0.5 h-full bg-border"></div>
                    )}
